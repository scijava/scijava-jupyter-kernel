 ...
 * @author kay schluehr
 */
public class GroovyConsole extends InteractiveConsole {

    public GroovyConsole(ScriptLanguage scriptLanguage) {
    ...
    public T_kernel_info_reply getKernelInfo() {
        ...
        kernelInfoReply.implementation = "groovy";
        
        kernelInfoReply.implementation_version = version;
        T_language_info languageInfo = new T_language_info();
        languageInfo.file_extension = ".groovy";
        languageInfo.name = "groovy";
        languageInfo.mimetype = "text/x-groovy";
        languageInfo.pygments_lexer = "groovy";
        languageInfo.version = version;
        kernelInfoReply.language_info = languageInfo;
        
        kernelInfoReply.banner = "Groovy " + version + "\n";
