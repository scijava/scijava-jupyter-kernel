...
public interface NotebookService extends SciJavaService {
	...
	/**
	 * Convenience enum to make it slightly easier to call {@link #display} with a
	 * known finite set of options.
	 */
	enum OutputType {

		HTML(HTMLNotebookOutput.class), IMAGE(ImageNotebookOutput.class), JPEG_IMAGE(
				JPGImageNotebookOutput.class), JSON(JSONNotebookOutput.class), LATEX(
						LatexNotebookOutput.class), MARKDOWN(MarkdownNotebookOutput.class), PLAIN(
								PlainNotebookOutput.class), PNG_IMAGE(
										PNGImageNotebookOutput.class), TABLE(HTMLTableNotebookOutput.class);
	 ...
	 *
	 * @param object
	 *            The object to convert to a notebook-friendly result.
	...
	/**
	 * Converts the input object to notebook-appropriate data of the specified type.
	 *
	 * @param object
	 *            The object to convert to a notebook-friendly result.
	 * @param outputType
	 *            The type of notebook-appropriate data.
	 * @return A result which is displays well in a notebook.
	 */
	 ...
	 *
	 * @param mimetype
	 *            The desired MIME type of the result.
	 * @param content
