...
public class DefaultImageJNotebookService extends AbstractService implements ImageJNotebookService {
	...
	@Override
	public <T extends RealType<T>> Object RAIToPNG(final RandomAccessibleInterval<T> source, //
	...
	@Override
	public <T extends RealType<T> & NativeType<T>> RandomAccessibleInterval<T> mosaic(final int[] gridLayout,
		...
		for (int i = 0; i < images.length; i++) {
			...
			Inplaces.binary1(ops, Ops.Math.Add.class, result, expanded).mutate1(result, expanded);
		}
